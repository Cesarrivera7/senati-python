...
def mensajeAdvertencia():
    messagebox.showwarning("Mensaje", "ERROR, tenemos un problema!")
...
ventana.title("APLICACION DE MENSAJE")
#Icono en la ventana 
...
boton2 = tk.Button(ventana, text="Error", width=10,height=5,command=mensajeInfo)  
